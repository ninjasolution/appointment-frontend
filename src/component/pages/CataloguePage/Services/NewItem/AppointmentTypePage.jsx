            ...
            <div className='choose-container'>
                ...
                <div className='choose-group'>
                    ...
                    <Link className='choose-item' to='/catalogue/services/add/form'>
                        ...
                        <span className='item-logo'>
                            <svg width="32" height="33" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M25 14.5v11.111a.89.89 0 0 1-.889.889H5a1 1 0 0 1-1-1v-14a1 1 0 0 1 1-1h5.667a1 1 0 0 1 .6.2l3.466 2.6a1 1 0 0 0 .6.2H24a1 1 0 0 1 1 1Z" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M25 14.5v11.111a.89.89 0 0 1-.889.889H5a1 1 0 0 1-1-1v-14a1 1 0 0 1 1-1h5.667a1 1 0 0 1 .6.2l3.466 2.6a1 1 0 0 0 .6.2H24a1 1 0 0 1 1 1Z" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M8 10.5v-3a1 1 0 0 1 1-1h5.667a1 1 0 0 1 .6.2l3.466 2.6a1 1 0 0 0 .6.2H28a1 1 0 0 1 1 1v11.111a.889.889 0 0 1-.889.889H25" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                        </span>
                    </Link>
                </div>
            </div>
