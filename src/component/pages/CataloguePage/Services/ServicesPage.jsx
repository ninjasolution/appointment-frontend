...
const ServicesPage = () => {
    ...
    const createCategoryHandler = () => {
        ...
        createPost(`/api/category`, {
            name: categoryName,
            description: categoryDescription,
            categoryColor: categoryColor,
            type: CATEGORY_TYPE_SERVICE
        }).then(res => {
            setNewCategoryMoal(false);
        })
    }
                    ...
                    <div className='modal-body'>
                        <div className="group">
                            ...
                            <div className='input-container'>
                                <input type="text" className='input-control' placeholder='e.g. Hair Services' value={categoryName} onChange={e => setCategoryName(e.target.value)} />
                            </div>
                        ...
                        <div className="group">
                            ...
                            <div className='input-container'>
                                <input type="text" className='input-control' placeholder='e.g. Hair Services' value={categoryColor} onChange={e => setCategoryColor(e.target.value)} />
                            </div>
                        </div>
                        <div className="group" style={{ margin: '0px 0px 20px' }}>
                            <span className='group-title'>Category description</span>
                            <div className='input-container'>
                                <textarea className='input-control' cols="30" rows="3" value={categoryDescription} onChange={e => setCategoryDescription(e.target.value)} />
                            </div>
                        </div>
                    </div>
                    <div className='modal-footer'>
                        <div className='action-container'>
                            <button className='action-control action-save' onClick={createCategoryHandler}>Save</button>
                        </div>
                    </div>
                </div>
            }
