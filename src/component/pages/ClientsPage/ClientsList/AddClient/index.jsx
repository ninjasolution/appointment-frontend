...
const AddClient = () => {
    ...
    const [enableSendEmail, setEnableEmail] = useState(false);
    const [enableAcceptEmail, setAcceptEmail] = useState(false);
    const [enableAcceptText, setAcceptText] = useState(false);
                    ...
                    <div className='modal-body'>
                        ...
                        <div className='group'>
                            ...
                            <div className="input-container">
                                ...
                                <input type="text" id='mobile-number' value={address} onChange={e => setAddress(e.target.value)} />
                            </div>
                        </div>
                        <div className='group'>
                    ...
                    <div className="basic-info group-container">
                        ...
                        <div className='two-group sub-container'>
                            <div className='group'>
                                ...
                                <div className='input-container'>
                                    <input type="text" id='mobile-number' placeholder="Enter client's mobile number" value={setPhone} onChange={e => setPhone(e.target.value)} />
                                </div>
                            </div>
                            <div className='group'>
                        ...
                        <div className='two-group sub-container' style={{ padding: '0px 26px 40px' }}>
                            <div className='group'>
                                ...
                                <div className='input-container'>
                                    <input type="month" id='date-birth' placeholder="Day and birth" value={birthday} onChange={e => setBirthday(e.target.value)} />
                                </div>
                                <span className='group-hint'></span>
                            </div>
                            <div className='group'>
                                ...
                                <div className='input-container'>
                                    <input type="text" id='year' placeholder="Year" value={setBirthYear} onChange={e => setBirthYear(e.target.value)} />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="important-client-info group-container">
                        ...
                        <div className='two-group sub-container'>
                            <div className='group'>
                                ...
                                <div className='input-container'>
                                    <textarea rows="8" placeholder='E.g. allergy to shampoos with sodium' value={setClientInfo} onChange={e => setClientInfo(e.target.value)} />
                                </div>
                            </div>
                        </div>
                        <div className='two-group sub-container'>
                    ...
                    <div className="additional-info group-container">
                        ...
                        <div className='two-group sub-container'>
                            <div className='group'>
                                ...
                                <div className='input-container'>
                                    <input type="text" id='mobile-number' placeholder="Enter client's additional number" value={setSecondPhone} onChange={e => setSecondPhone(e.target.value)} />
                                </div>
                            </div>
                        </div>
