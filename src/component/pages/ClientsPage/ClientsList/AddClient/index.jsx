                            ...
                            <div className='group'>
                                <div className='check-container'>
                                    <div className='form-check'>
                                        <input className="form-check-input" id='display-all-select' type="checkbox" defaultChecked value={enableSendEmail} onChange={e => setEnableSendEmail(e.target.checked)} />
                                        <span className='check-content' onClick={() => document.getElementById('display-all-select').click()}>Display all settings</span>
                                    </div>
                                </div>
                                <span className='group-hint'></span>
                            </div>
