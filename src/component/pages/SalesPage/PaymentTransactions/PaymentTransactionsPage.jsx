            ...
            <div className='detail-container'>
                ...
                <div className='content-setting'>
                    ...
                    <div className='select-month'>
                        <button>18 Jan, 2023 - 17 Feb, 2023</button>
                    </div>
                ...
                <div className='content-details'>
                    <div className='table-container'>
                        <table>
                            ...
                            <tbody>
                                <tr className='sticky-result'>
                                    <td className='font-left bold'>Total</td>
                                    <td className='font-left'></td>
                                    <td className='font-left'></td>
                                    <td className='font-left'></td>
                                    <td className='font-left'></td>
                                    <td className='font-left'></td>
                                    <td className='font-right bold'>$127.60</td>
                                    <td className='font-left'></td>
                                </tr>
                                <tr>
                                    <td className='font-left'>14 Feb 2023, 03:32</td>
                                    <td className='font-left ref-name'>2</td>
                                    <td className='font-left'>Sdfsdwer erwe</td>
