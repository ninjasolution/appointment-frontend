                ...
                <div className='content-details'>
                    <div className='transaction-container'>
                        ...
                        <div className='transaction-detail'>
                            <table>
                                <tr>
                                    <th className='font-left' style={{width: '23%'}}>Item type</th>
                    ...
                    <div className='cash-container'>
                        ...
                        <div className='cash-detail'>
                            <table>
                                <tr>
                                    <th className='font-left' style={{width: '30%'}}>Payment type</th>
                                    <th className='font-right' style={{width: '30%'}}>Payments collected</th>
