...
import { addProductAction } from '../../../../../store/actions/GlobalAction';
import '../newsale.scss';
                        ...
                        <tbody>
                            {
                                products?.map((item, key) => (
                                    <tr key={key} onClick={() => dispatch(addProductAction(item))}>
                                        <td className='product-info'>
                                            ...
                                            <div>
                                                ...
                                                <span id='product-content'>SKU: {item?.skus[0]}</span>
                                            </div>
                                        </td>
                                        <td>{item?.category}</td>
                                        ...
                                        <td className='product-price'>
                                            <div>
                                                <span id='current-price'>RUB {item?.price}</span>
                                                <span id='real-price'>RUB {item?.retailPrice}</span>
                                            </div>
                                        </td>
                                    </tr>
                                ))
